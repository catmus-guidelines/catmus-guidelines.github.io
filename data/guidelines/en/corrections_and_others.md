...
- first, the <span class="rule">interlinear addition MUST be considered a separate text line</span>, typed accordingly using the SegmOnto vocabulary. 
- second, when a symbol is used in the source to mark where the interlinear addition should be inserted, the <span class="rule">insertion symbol MAY be transcribed with "‸" [U+2038]</span>.
